...
function DefaultTabBar(props){_classCallCheck(this,DefaultTabBar);return _possibleConstructorReturn(this,(DefaultTabBar.__proto__||Object.getPrototypeOf(DefaultTabBar)).call(this,
props));
...
return(
_react2.default.createElement(_Button.Button,{style:{flex:1},key:name,onPress:function onPress(){return onPressHandler(page);},__source:{fileName:_jsxFileName,lineNumber:51}},
_react2.default.createElement(_index.TabHeading,{style:currTabStyle,active:isTabActive,__source:{fileName:_jsxFileName,lineNumber:52}},
_react2.default.createElement(_index.Text,{style:currTextStyle,__source:{fileName:_jsxFileName,lineNumber:53}},name))));



}else{
return(
_react2.default.createElement(_Button.Button,{style:{flex:1},key:_lodash2.default.random(1.2,5.2),onPress:function onPress(){return onPressHandler(page);},__source:{fileName:_jsxFileName,lineNumber:59}},
_react2.default.createElement(_index.TabHeading,{style:tabHeaderStyle,active:isTabActive,__source:{fileName:_jsxFileName,lineNumber:60}},
headerContent)));
...
return(
_react2.default.createElement(_index.TabContainer,{style:this.props.tabContainerStyle?this.props.tabContainerStyle:{},__source:{fileName:_jsxFileName,lineNumber:87}},
...
_react2.default.createElement(_reactNative.Animated.View,{style:[tabUnderlineStyle,{left:left},this.props.underlineStyle],__source:{fileName:_jsxFileName,lineNumber:117}})));
