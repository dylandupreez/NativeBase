...
style:{width:_this4.state.containerWidth},__source:{fileName:_jsxFileName,lineNumber:132}},

_this4._keyExists(_this4.state.sceneKeys,key)?
child:

_react2.default.createElement(_reactNative.View,{heading:child.props.heading,__source:{fileName:_jsxFileName,lineNumber:140}})));
...
return _react2.default.createElement(_DefaultTabBar.DefaultTabBar,_extends({},props,{__source:{fileName:_jsxFileName,lineNumber:215}}));
}
...
onScroll:function onScroll(e){return _this6._onScroll(e);},
onMomentumScrollBegin:function onMomentumScrollBegin(e){return _this6._onMomentumScrollBeginAndEnd(e);},
onMomentumScrollEnd:function onMomentumScrollEnd(e){return _this6._onMomentumScrollBeginAndEnd(e);},
...
this.props.contentProps,{__source:{fileName:_jsxFileName,lineNumber:222}}),
...
var tabBarProps={
goToPage:function goToPage(pageNumber){return _this7.goToPage(pageNumber);},
...
return(
_react2.default.createElement(_reactNative.View,{style:[styles.container,this.props.style],onLayout:function onLayout(e){return _this7._handleLayout(e);},__source:{fileName:_jsxFileName,lineNumber:296}},
this.props.tabBarPosition==="top"&&this.renderTabBar(tabBarProps),
this.renderScrollableContent(),
(this.props.tabBarPosition==="bottom"||overlayTabs)&&this.renderTabBar(tabBarProps)));


}}]);return ScrollableTabView;}(_react.Component);ScrollableTabView.propTypes={tabBarPosition:_propTypes2.default.oneOf(["top","bottom","overlayTop","overlayBottom"]),initialPage:_propTypes2.default.number,page:_propTypes2.default.number,onChangeTab:_propTypes2.default.func,onScroll:_propTypes2.default.func,renderTabBar:_propTypes2.default.any,style:_Utils.ViewPropTypes.style,contentProps:_propTypes2.default.object,scrollWithoutAnimation:_propTypes2.default.bool,locked:_propTypes2.default.bool,prerenderingSiblingsNumber:_propTypes2.default.number};ScrollableTabView.defaultProps={tabBarPosition:"top",initialPage:0,page:-1,onChangeTab:function onChangeTab(){},onScroll:function onScroll(){},contentProps:{},scrollWithoutAnimation:false,locked:false,prerenderingSiblingsNumber:0};exports.default=
